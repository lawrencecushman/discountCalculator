...
the Activity as the Action Listener. This avoids the extra class load and object 
allocation, and allows the use of the same action for multiple Views.
...
public class DiscountCalculator extends Activity implements OnEditorActionListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Both edit fields below utilize the same onEditorAction, which simply means, 
		// if either field is edited and submitted, via the 'Next' or 'Done' buttons,
		// the result TextView will be updated.
	...
	public boolean onEditorAction(TextView v, int actionId,	KeyEvent event) {
		...
		return false; // This will cause the keyboard to hide when 'Done' or 'Next' is clicked
	}
}
